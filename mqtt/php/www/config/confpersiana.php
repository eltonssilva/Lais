...
var txt = $("#feedback");
    ...
    $(document).ready(function () {
		...
		$('.btnHome').click(function () {
				prepara_mqtt("19", "/house/persiana/" + numeroserial);
             }); 
			 
		$('.btnSubir').click(function () {
				prepara_mqtt("20", "/house/persiana/" + numeroserial);
             }); 
		$('.btnDescer').click(function () {
				prepara_mqtt("21", "/house/persiana/" + numeroserial);
             }); 
			 
		$('.btnAbrir').click(function () {
				prepara_mqtt("22", "/house/persiana/" + numeroserial);
             }); 
			 
		$('.btnParar').click(function () {
				prepara_mqtt("23", "/house/persiana/" + numeroserial);
             }); 
			 
		$('.btnFechar').click(function () {
				prepara_mqtt("24", "/house/persiana/" + numeroserial);
             }); 
			 
		$('.btnReset').click(function () {
				prepara_mqtt("16", "/house/persiana/" + numeroserial);
             }); 
			 
		$('.btnInverter_Sentido').click(function () {
				prepara_mqtt("25", "/house/persiana/" + numeroserial);
             }); 			 
		...
		$('.btn1').click(function () {
			var comando_mqtt_ = $(".comandos_select").val();
				prepara_mqtt(comando_mqtt_, "/house/persiana/" + numeroserial);
             }); 
...
<a class="waves-effect waves-light btn-small blue accent-3 btn btnHome">Home</a>
<a class="waves-effect waves-light btn-small blue accent-3 btn btnSubir">Subir</a>
<a class="waves-effect waves-light btn-small blue accent-3 btn btnDescer">Descer</a>
...
<a class="waves-effect waves-light btn-small blue accent-3 btn btnReset">Reset</a>
...
<div class="selecao">
  ...
  <select class="browser-default comandos_select">
	...
	<option value="20">Subir</option>
	<option value="21">Descer</option>
	...
	<option value="32">Checar Parametro</option>
