...
//		                                      (NULL, '{$id_widget}', '{$codigo}', '{$setSubTopic0}', '{$setPubTopic0}', '{$estado}', '{$Descricao}',  'X', '{$habilitado}');";

		$query = "INSERT INTO `rx433mhz_portas` (`id`, `id_widget` ,`codigo`, `topico`, `topico_confirma`, `carga`, `descricao`, `habilitado`) VALUES (NULL, '{$id_widget}', '{$codigo}', '{$setPubTopic0}', '{$setSubTopic0}', '{$estado}', '{$Descricao}', '{$habilitado}');";											  
	//	echo $query;
...
<label class="w3-label w3-text-blue"><b>Dispositivo a ser acionado</b></label>
        <select class="w3-input w3-border" name="dispositivos">
					...
					<?php 
                         echo "<option value=" . '1' . ">" . Panico . "</option>"; 
                     ?>
          </select>
