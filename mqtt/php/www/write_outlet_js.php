...
client.on('message', function(topic, message) {
  console.log('Temp = ' + message);
    ...
    light
      ...
      TOMADA_AUTODOMUM.powerOn = false;
	light
      .getService(Service.Outlet)
...
var lightUUID = uuid.generate('hap-nodejs:accessories:{$outronamehomekit}_{$aleatorio_username2}');
...
light
  .addService(Service.Outlet, '{$namehomekit}') // services exposed to the user should have 'names' like 'Fake Light' for us
  .getCharacteristic(Characteristic.On)
  .on('set', function(value, callback) {
    TOMADA_AUTODOMUM.setPowerOn(value);
