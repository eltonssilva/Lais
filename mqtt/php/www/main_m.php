...
<?php if($rec['tipo_geral']=='2')
{ ?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/sensores.php?<?php echo 'id=' . $rec['id'] . '&topic=' . $rec['setPubTopic0'];?>"><img src="/png/64/drop.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
...
<?php if($rec['tipo_geral']=='3')
{ ?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/sensores.php?<?php echo 'id=' . $rec['id'] . '&topic=' . $rec['setPubTopic0'];?>"><img src="/png/64/temperature.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
...
<?php if($rec['tipo_geral']=='4')
{ ?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/sensores.php?<?php echo 'id=' . $rec['id'] . '&topic=' . $rec['setPubTopic0'];?>"><img src="/png/64/lux.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
...
?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/bulbrgb.php?<?php echo 'id=' . $rec['id'] . '&topic=' . $rec['setPubTopic0'];?>"><img src="/png/64/rgb.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
 <th>
 <div class="onoffswitch">
...
<!--
<input  id="rgbuton<?php echo $rec['id']; ?>" class="jscolor color<?php echo $rec['id']; ?>" onchange="rgbbt(this.id, this.jscolor, '<?php echo $rec['setPubTopic0']; ?>')"  value="cc66ff" maxlength="17" size="7">
 -->
</th>
</tr>
<?php } ?>
...
<?php if($rec['tipo_geral']=='6')
{ ?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/sensores.php?<?php echo 'id=' . $rec['id'] . '&topic=' . $rec['setPubTopic0'];?>"><img src="/png/64/houseplant.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
<th  class="<?php echo $rec['id']; ?>"  ><?php echo $valor; ?> %</th>
</th>
...
<?php if($rec['tipo_geral']=='7')
{ ?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/sensores.php?<?php echo 'id=' . $rec['id'] . '&topic=' . $rec['setPubTopic0'];?>"><img src="/png/64/atmospheric_pressure.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
...
<?php if($rec['tipo_geral']=='8')
{ ?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/sensores.php?<?php echo 'id=' . $rec['id'] . '&topic=' . $rec['setPubTopic0'];?>"><img src="/png/64/altitude.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
...
?>
<tr id="row<?php echo $rec['ordem']; ?>">
<th><a href="/persiana.php?<?php echo 'id=' . $rec['id'];?>"><img src="/png/64/persiana.png" alt="Smiley face" height="64" width="64"></th> 
<th><?php echo $rec['Descricao']; ?></th>
<th><?php echo $desc_ambiente; ?></th>
 <th>
 <div class="onoffswitch">
 <input type="checkbox" onclick="return pubmqttpersiana('myonoffswitch<?php echo $rec['id']; ?>', '<?php echo $rec['setPubTopic0']; ?>', '1')" name="onoffswitch<?php echo $rec['id']; ?>" class="onoffswitch-checkbox <?php echo $rec['id']; ?>"  id="myonoffswitch<?php echo $rec['id']; ?>"  <?php  echo $checked ?>>
