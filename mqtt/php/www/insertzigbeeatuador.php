...
$query = "SELECT id, Descricao, username_iphone, setPubTopic0 FROM widget WHERE tipo_geral = 17 OR tipo_geral = 2 OR tipo_geral = 3 OR tipo_geral = 4  OR tipo_geral = 9 OR tipo_geral = 7 OR tipo_geral = 1 OR tipo_geral = 14  OR tipo_geral = 20  OR tipo_geral = 10";
mysqli_set_charset($con, 'utf8');
