...
$setPubTopic0 = $rec['setPubTopic0'];
		...
		$query = "update `autohome`.`rx433mhz_persiana` set `codigo`= '{$codigo}', `id_widget`= '{$id_widget}', `topico` = '{$setPubTopic0}', `topico_confirma` = '{$setSubTopic0}', `descricao` =  '{$Descricao}',  `carga` =  '{$estado}', `habilitado` =  '{$habilitado}'  where id = '{$id}'";
