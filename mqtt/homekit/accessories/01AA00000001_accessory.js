...
var options = {
  ...
  clientId: '01AA00000001' //muda aqui para cada novo dispositivo
};
var client = mqtt.connect(options);
console.log('Dispositivo Conectado para MQTT broker');

client.subscribe('/house/confirma/01AA00000001');
...
var LAMPADA_AUTOHOME = {
  ...
  setPowerOn: function(on) {
    ...
    if (on) {
      client.publish('/house/iluminacao/01AA00000001', '1', {retain: true});   //Topico a Ser alterado
      LAMPADA_AUTOHOME.powerOn = on;
   	}
    else {
	    client.publish('/house/iluminacao/01AA00000001','0', {retain: true});   //Topico a ser alterado
      LAMPADA_AUTOHOME.powerOn = false;
   };
...
var lightUUID = uuid.generate('hap-nodejs:accessories:LampadaDoc');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var light = exports.accessory = new Accessory('Lampada Doc', lightUUID);


// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
light.username = '01:AA:00:00:00:01:8D:1C';
light.pincode = '844-32-227';
...
light
  .addService(Service.Lightbulb, 'Lampada Doc') // services exposed to the user should have 'names' like 'Fake Light' for us
